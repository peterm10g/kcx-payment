 ...
 * desc:
 */
public class WxGrouponBillStrategy implements BillStrategy {

    private Logger logger = LoggerFactory.getLogger(WxGrouponBillStrategy.class);
...
//    public static String url = "https://api.mch.weixin.qq.com/pay/downloadbill";
    ...
    public boolean downloadBillByDate(String billDate, int wxType) {
        try {
            String wxpayKey = "";
            String billFileName = "";
            String downLoadBillPath = BusiConstant.BILL_DOWNLOAD_PATH_WX_GROUPON + File.separator + DateUtil.getDateString();
