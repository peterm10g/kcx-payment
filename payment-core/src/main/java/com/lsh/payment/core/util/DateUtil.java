...
public class DateUtil {
    ...
    public static final String formatDefaultTimestampStr = "yyyyMMddHHmmssSSS";
    ...
    public static String defaultTimestampStr(Date date) {
        return format(date, new SimpleDateFormat(formatDefaultTimestampStr));
    }
    ...
    public static String formatTime(Date date) {
        return format(date, new SimpleDateFormat(formatTime));
    }
    ...
    public static Date parsePayDate(String ds) {
        SimpleDateFormat format = new SimpleDateFormat(formatTime);
        return parse(ds, format);
    }

    public static Date parsePayDate_1(String ds) {
     ...
     * @return
     */
    public static Date getDateTimeBefore(int num) {
        Calendar calendar = Calendar.getInstance();
    ...
    public static String getYesterdayLine(){
        Calendar cal = Calendar.getInstance();
        cal.add(Calendar.DATE, -1);
    ...
    public static String nowStr(){
        return defaultTimestampStr(new Date());
    }

    public static String nowStrFormate(){
        return defaultTime(new Date());
    }
