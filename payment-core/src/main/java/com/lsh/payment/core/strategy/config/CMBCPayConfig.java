...
public class CMBCPayConfig {
    ...
    public static final String PAY_NATIVE = "/unifiedOrder20";
    public static final String PAY_QUERY = "/orderQuery20";
    ...
    public static final String CMBC_PAY_TITLE = "链商优供-支付(订单号:{0})";
