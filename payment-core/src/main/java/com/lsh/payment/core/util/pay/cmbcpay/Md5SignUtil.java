...
public class Md5SignUtil {
	...
	public static String getRequestQueryString(Map<String, String> params, String mkey) {
		...
		for (Iterator<String> it = resultMap.keySet().iterator(); it.hasNext();) {
			String key = it.next();
			if(StringUtils.equals("SIGN", key) ||  StringUtils.equalsIgnoreCase("SIGNIN", key)  || StringUtils.equalsIgnoreCase("SIGNOUT", key) || StringUtils.equalsIgnoreCase("callback", key)){
				continue;
			}
