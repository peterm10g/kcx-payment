 ...
 * <pre>
 * 签名相关工具类
 * Created by miaozhuang on 2017-3-23.
...
public class SignUtils {
  ...
  public static String createSignCMBC(Map<String, String> params, String signKey) {
    ...
    String toSignStr = toSign.substring(0, toSign.length() - 1) + signKey;
//    toSign.append("key=").append(signKey);
